...
void MainWindow::CreateActions()
{
	...
	action_input_->setStatusTip(tr("Input data points"));
	connect(action_input_, SIGNAL(triggered()), imagewidget_, SLOT(Input()));

	action_idw_ = new QAction(tr("IDW"), this);
	action_idw_->setStatusTip(tr("Warping->IDW"));
	connect(action_idw_, SIGNAL(triggered()), imagewidget_, SLOT(WarpingIDW()));

	action_rbf_ = new QAction(tr("RBF"), this);
	action_rbf_->setStatusTip(tr("Warping->RBF"));
	connect(action_rbf_, SIGNAL(triggered()), imagewidget_, SLOT(WarpingRBF()));
